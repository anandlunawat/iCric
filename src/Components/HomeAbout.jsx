export default function HomeAbout() {
    return (
        <div className="flex flex-col p-6 bg-gray-100">
            ...
            <div className="flex flex-col mt-4 mb-2 lg:bg-right lg:bg-no-repeat lg:bg-contain lg:gap-36 lg:w-[90%] lg:bg-about lg:flex lg:flex-row" style={{backgroundSize : "25% 95%"}}>
                <div className="flex flex-col gap-4 p-4 basis-[50%]">
                    ...
                    <span className="font-normal text-indigo-900">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip</span>
                    <span className="font-normal text-indigo-900">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip</span>
                    <a href="/" className="p-2 rounded-md text-center border-2 w-[35%] whitespace-pre border-lime-500 text-lime-500">Know More</a>
                </div>
                <div className="self-center py-4 lg:hidden justify-self-center basis-1/2">
